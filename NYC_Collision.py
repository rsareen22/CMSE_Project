...
st.subheader('Author: Rishabh Sareen')
st.text("This application is a Streamlit dashboard that can be ")
st.text("used to analyze motor vehicle collisions in New York City")
